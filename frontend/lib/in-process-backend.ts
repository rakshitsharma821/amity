    ...
    if (!specData || !specData.paths) {
      return {
        ...
        endpoints: [
          ...
          { id: 'ep-3', path: '/me/orders', method: 'GET', authenticationRequired: true, roles: ['customer'] },
          { id: 'ep-4', path: '/login', method: 'POST', authenticationRequired: false, roles: [] },
          { id: 'ep-5', path: '/admin/users/{id}/role', method: 'POST', authenticationRequired: true, roles: ['admin'] },
        ],
      };
    }
