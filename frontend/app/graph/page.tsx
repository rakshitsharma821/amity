      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#111114]/80 p-6">
          ...
          <p className="text-xs text-zinc-400 mb-5 leading-relaxed">
            Vanguarda-api structures authorization boundaries into five deterministic topological tiers. Probes systematically traverse these tiers to detect broken boundaries and identify cross-tenant data leaks.
          </p>
