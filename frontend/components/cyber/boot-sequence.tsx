...
const BOOT_LINES = [
  'initializing sentinel core v3.2.0...',
      ...
      >
        ...
        <div className="flex items-center justify-between pb-3 mb-4 border-b border-white/10 text-muted-dim">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-muted-body ml-2">sentinel@soc-terminal:~</span>
          </div>
          <button
            type="button"
            onClick={() => {
        ...
        <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between text-[10px] text-muted-dim">
          <span className="text-terminal font-bold">SENTINEL SOC V3.2</span>
