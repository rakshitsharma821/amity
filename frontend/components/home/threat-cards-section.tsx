    ...
    <section className="py-24 border-t border-white/10 bg-transparent">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-base sm:text-lg text-muted-body max-w-2xl mb-12 font-mono text-sm">
          Generic DAST tools report hundreds of false positives on public pages. SentinelAPI audits authorization context directly using dual authenticated sessions.
        </p>
